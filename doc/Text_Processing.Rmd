...
word <- c("lot", "today", "months", "month", "wanna", "wouldnt", "wasnt", "ha", "na", "ooh", "da",
        "gonna", "dont", "aint", "wont", "yeah", "la", "oi", "nigga", "fuck",
          "hey", "year", "years", "last", "past", "feel")
stop_words <- stop_words[-which(stop_words$word=="i" | stop_words$word=="you" | stop_words$word=="we" | stop_words$word=="they"),]
stop_words <- c(stop_words$word, word)
# redefine the data required
dt_lyrics <- dt_lyrics[which(dt_lyrics$genre=="Rock" | dt_lyrics$genre=="Pop"),]
...
```{r export data}
save(dt_lyrics, file="../output/processed_lyrics_rp.RData")
```
